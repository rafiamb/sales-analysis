...
- **Electronics** delivers nearly as much total profit as Toys despite selling less than half the units — the highest-margin category at 46%
- **Airport stores** average 126,016 profit per store — 63% more than Downtown, Commercial, or Residential locations, which are all within 1% of each other
- **Ciudad de Mexico** accounts for 3 of the top 10 stores by profit, followed by Guadalajara and Monterrey
- **December is the peak month** across both years — revenue spikes ~45% above the August low, driven by Christmas demand
- **2023 outperforms 2022 in every single month** — the business is growing year over year across all store types and categories
- The **2000-2004 store cohort** generates the highest average profit per store at 88,489 — outperforming newer cohorts on a per-store basis
...
- December is consistently the highest revenue month — 877k in 2022 and the peak across both years
...
- The location decisions made during that period have proven most durable — new site selection should study what those stores have in common
